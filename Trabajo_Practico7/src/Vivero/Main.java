...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(floreria.listarPlantas(new FiltroNombreCientifico("aureum")));
		
		System.out.println("\nTodas las plantas a las que se conozca vulgarmente como “lengua de suegra”");
		System.out.println(floreria.listarPlantas(new FiltroNombreVulgar("lengua de suegra")));
		
		System.out.println("\nTodas las plantas cuya clasificación sea “Crassula”");
		System.out.println(floreria.listarPlantas(new FiltroClasificacion("Crassula")));
		
		System.out.println("\nTodas las plantas que requieran un nivel de sol superior a 5 y riego inferior a 3");
		System.out.println(floreria.listarPlantas(new FiltroSolYRiego(5, 3)));
		
		System.out.println("\nTodas las plantas de interior que necesiten poco riego (inferior a 3)");
		System.out.println(floreria.listarPlantas(new FiltroInteriorRiego(3)));
	}
